...
CONN_STR = "DRIVER={ODBC Driver 17 for SQL Server}"+";SERVER={0};PORT={1};DATABASE={2};".format(_SERVER, _DB_PORT, _DATABASE) + ("Trusted_Connection=yes" if _USE_TRUSTED_CONN == "1" else "UID={0};PWD={1}".format(
    _USERNAME, _PASSWORD
))
