...
_USE_TRUSTED_CONN = os.environ.get('TRUSTED_CONN', False)
_USERNAME = os.environ.get('DB_USERNAME', '')
_PASSWORD = os.environ.get('DB_PASSWORD', '')

CONN_STR = "DRIVER={ODBC Driver 17 for SQL Server};" + ("SERVER={0};DATABASE={1};Trusted_Connection=yes".format(_SERVER, _DATABASE) if _USE_TRUSTED_CONN else "SERVER={0};PORT=1433;DATABASE={1};UID={2};PWD={3}".format(
